...
htmlhelp_basename = 'MuseoPhenodoc'
...
latex_documents = [
    (master_doc, 'MuseoPheno.tex', 'Museo ToolBox Documentation',
...
man_pages = [
    (master_doc, 'museopheno', 'MuseoPheno Documentation',
     [author], 1)
]
